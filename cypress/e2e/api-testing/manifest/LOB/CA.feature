Feature: Commercial Auto - CA
  ...
  Scenario: Delete report folder before all tests
    Given Delete "./reports/CA" folder

  Scenario Outline: The user validates the search result for Product line - Commercial Auto, state - Pennsylvania, Publication Category - '<pubCategory>' and Publication Type - '<pubType>' with Data base connectivity
